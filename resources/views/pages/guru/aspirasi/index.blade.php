@extends('layouts.app')
@section('title', 'Daftar Aspirasi | Guru')
...
<div class="row">
    <div class="col-12">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <div>
                <h4 class="mb-1">
                    <iconify-icon icon="solar:list-bold-duotone" class="me-2 text-primary"></iconify-icon>
                    Daftar Aspirasi Saya
                </h4>
                <p class="text-muted mb-0">Semua aspirasi yang sudah kamu kirimkan</p>
            </div>
            <a href="{{ route('guru.aspirasi.create') }}" class="btn btn-primary btn-sm">
                ...
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="searchInput" class="form-control" placeholder="Cari lokasi, kategori...">
                        </div>
                    </div>
                    <div class="col-auto">
...
{{-- Modal Detail --}}
<div class="modal fade" id="detailAspirasModal" tabindex="-1" aria-hidden="true">
...
function renderTable(res) {
    if (!res.data.length) {
        $('#tabelBody').html('<tr><td colspan="7" class="text-center text-muted py-4">Tidak ada aspirasi ditemukan.</td></tr>');
    ...
    res.data.forEach(function(d, i) {
        ...
        html += `<tr>
            ...
            <td class="text-center">
                <button class="btn btn-sm btn-soft-info" onclick="lihatDetail(${d.id})" title="Detail">
