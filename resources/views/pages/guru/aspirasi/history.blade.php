@extends('layouts.app')
@section('title', 'Histori Aspirasi | Guru')
        ...
        @if ($histori->isEmpty())
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <a href="{{ route('guru.aspirasi.create') }}" class="btn btn-primary btn-sm mt-2">Kirim Aspirasi Pertama</a>
                </div>
            </div>
        @else
            <div class="card">
                                    ...
                                    <div class="card-body py-2 px-3">
                                        <div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                @if($inputAspirasi)
                                                    <button class="btn btn-sm btn-soft-info py-0 px-2" onclick="lihatDetail({{ $inputAspirasi->id }})">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><iconify-icon icon="solar:document-bold-duotone" class="me-2"></iconify-icon>Detail Aspirasi</h5>
