    ...
    <div class="col-12">
        ...
        <div class="alert alert-primary d-flex align-items-center mb-4" role="alert">
            ...
            <div>
                ...
                Berikut adalah ringkasan data aspirasi sarana di lingkungan sekolah.
            </div>
        </div>

        {{-- Stat Cards Baris 1: Aspirasi --}}
                ...
                <div class="card overflow-hidden h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="avatar-md bg-soft-secondary rounded">
                                <iconify-icon icon="solar:book-bold-duotone" class="avatar-title fs-24 text-secondary"></iconify-icon>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card overflow-hidden h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="avatar-md bg-soft-secondary rounded">
                                <iconify-icon icon="solar:user-id-bold-duotone" class="avatar-title fs-24 text-secondary"></iconify-icon>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h3 class="text-primary mb-0">{{ $aspirasiSiswa }}</h3>
                            </div>
                            <div class="avatar-md bg-soft-primary rounded">
                                <iconify-icon icon="solar:diploma-bold-duotone" class="avatar-title fs-24 text-primary"></iconify-icon>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-6 col-md-3">
                <div class="card overflow-hidden h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <p class="text-muted mb-1 small">Aspirasi Guru</p>
                                <h3 class="text-info mb-0">{{ $aspirasiGuru }}</h3>
                            </div>
                            <div class="avatar-md bg-soft-info rounded">
                                <iconify-icon icon="solar:teacher-bold-duotone" class="avatar-title fs-24 text-info"></iconify-icon>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                <a href="{{ route('kepala_sekolah.aspirasi.index') }}" class="card text-decoration-none h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="avatar-md bg-soft-primary rounded">
                            <iconify-icon icon="solar:list-bold-duotone" class="avatar-title fs-24 text-primary"></iconify-icon>
                        </div>
                        <div>
                            <h6 class="mb-1 text-dark">Lihat Semua Aspirasi</h6>
                            <p class="text-muted mb-0 small">Pantau seluruh laporan aspirasi sarana</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-md-6">
                <a href="{{ route('kepala_sekolah.history.index') }}" class="card text-decoration-none h-100">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="avatar-md bg-soft-success rounded">
                            <iconify-icon icon="solar:history-bold-duotone" class="avatar-title fs-24 text-success"></iconify-icon>
                        </div>
                        <div>
                            <h6 class="mb-1 text-dark">Histori Status Aspirasi</h6>
                            <p class="text-muted mb-0 small">Lihat riwayat perubahan status semua aspirasi</p>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('kepala_sekolah.aspirasi.index') }}" class="btn btn-sm btn-outline-primary">
                    Lihat Semua
                </a>
            </div>
                        ...
                        <tbody>
                            @forelse ($terbaru as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge {{ $statusMap[$item->aspirasi?->status] ?? 'bg-secondary' }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">Belum ada aspirasi masuk.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
